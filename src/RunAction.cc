...
void RunAction::BeginOfRunAction(const G4Run* aRun)
{
  ...
  G4cout << "The phantom is " << detectorMess->GetPhantomType() << " with dimensions: "
  << detectorMess->GetPhantomWidth()/mm << " mm width, "
  << detectorMess->GetPhantomThickness()/mm << " mm thickness." << G4endl;
}
